...
function L(b){var c=null;try{if(c=b&&b.contentDocument)return c}catch(e){}try{if(c=b.contentWindow&&b.contentWindow.document)return c}catch(e){}try{if(c=window._dv_win.frames&&window._dv_win.frames[b.name]&&window._dv_win.frames[b.name].document)return c}catch(e){}return null}function H(b){var c=0,e;for(e in b)b.hasOwnProperty(e)&&++c;return c}function M(b,c){a:{var e={};try{if(b&&b.performance&&b.performance.getEntries){var g=b.performance.getEntries();for(b=0;b<g.length;b++){var d=g[b],f=d.name.match(/.*\/(.+?)\./);
if(f&&f[1]){var n=f[1].replace(/\d+$/,""),l=c[n];if(l){for(var u=0;u<l.stats.length;u++){var q=l.stats[u];e[l.prefix+q.prefix]=Math.round(d[q.name])}delete c[n];if(!H(c))break}}}}var k=e;break a}catch(m){}k=void 0}if(k&&H(k))return k}function N(b,c){var e,g=window._dv_win.document.visibilityState;window[b.tagObjectCallbackName]=function(d){var f=window._dv_win.$dvbs;if(f){var n=c?"https:":J();e=d.ImpressionID;f.tags.add(d.ImpressionID,b);f.tags[d.ImpressionID].set({tagElement:b.script,impressionId:d.ImpressionID,
dv_protocol:b.protocol,protocol:n,uid:b.uid,serverPublicDns:d.ServerPublicDns,ServerPublicDns:d.ServerPublicDns});b.script&&b.script.dvFrmWin&&(b.script.dvFrmWin.$uid=d.ImpressionID,f.messages&&f.messages.startSendingEvents&&f.messages.startSendingEvents(b.script.dvFrmWin,d.ImpressionID));(function(){function f(){var c=window._dv_win.document.visibilityState;"prerender"===g&&"prerender"!==c&&"unloaded"!==c&&(g=c,window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(b,
f))}if("prerender"===g)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0});else{var b;"undefined"!==typeof window._dv_win.document.hidden?b="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?b="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?b="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(b="webkitvisibilitychange");
window._dv_win.document.addEventListener(b,f,!1)}})()}try{var l=M(window,{verify:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});l&&window._dv_win.$dvbs.registerEventCall(d.ImpressionID,l)}catch(u){}};window[b.callbackName]=function(c){var f=window._dv_win.$dvbs&&"object"==typeof window._dv_win.$dvbs.tags[e]?window._dv_win.$dvbs.tags[e]:b;var d=window._dv_win.dv_config.bs_renderingMethod||function(c){document.write(c)};switch(c.ResultID){case 1:f.tagPassback?d(f.tagPassback):c.Passback?d(decodeURIComponent(c.Passback)):
...
c.AdWidth+"px%3B%20height%3A%20"+c.AdHeight+"px%3B%22%3E%09%0A%3C%2Fdiv%3E"))}}}function O(b){var c=null,e=null,g=function(c){var b=dv_GetParam(c,"cmp");c=dv_GetParam(c,"ctx");return"919838"==c&&"7951767"==b||"919839"==c&&"7939985"==b||"971108"==c&&"7900229"==b||"971108"==c&&"7951940"==b?"</scr'+'ipt>":/<\/scr\+ipt>/g}(b.src);"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var d=function(b){!(b=b.previousSibling)||"#text"!=b.nodeName||
null!=b.nodeValue&&void 0!=b.nodeValue&&0!=b.nodeValue.trim().length||(b=b.previousSibling);if(b&&"SCRIPT"==b.tagName&&b.getAttribute("type")&&("text/adtag"==b.getAttribute("type").toLowerCase()||"text/passback"==b.getAttribute("type").toLowerCase())&&""!=b.innerHTML.trim()){if("text/adtag"==b.getAttribute("type").toLowerCase())return c=b.innerHTML.replace(g,"\x3c/script>"),{isBadImp:!1,hasPassback:!1,tagAdTag:c,tagPassback:e};if(null!=e)return{isBadImp:!0,hasPassback:!1,tagAdTag:c,tagPassback:e};
e=b.innerHTML.replace(g,"\x3c/script>");b=d(b);b.hasPassback=!0;return b}return{isBadImp:!0,hasPassback:!1,tagAdTag:c,tagPassback:e}};return d(b)}function I(b,c,e,g,d,f,n,l,u,q){var k;void 0==c.dvregion&&(c.dvregion=0);try{var m=g;for(k=0;10>k&&m!=window._dv_win.top;)k++,m=m.parent;g.depth=k;var h=P(g);var r="&aUrl="+encodeURIComponent(h.url);var y="&aUrlD="+h.depth;var B=g.depth+d;f&&g.depth--}catch(w){y=r=B=g.depth=""}void 0!=c.aUrl&&(r="&aUrl="+c.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==
...
0,{}));c.hasOwnProperty("err")&&(b=c.err);return{vdcv:25,vdcd:c.res,err:b}}catch(e){return{vdcv:25,vdcd:"0",err:b}}}function P(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var e,g=1,d=0;0<g&&100>d;){try{if(d++,e=c.shift(),g--,0<e.win.location.toString().length&&e.win!=b)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,depth:e.depth-1}}catch(l){}var f=e.win.frames.length;for(var n=
0;n<f;n++)c.push({win:e.win.frames[n],depth:e.depth+1}),g++}return{url:"",depth:""}}catch(l){return{url:"",depth:""}}}function F(b){new String;var c=new String,e;for(e=0;e<b.length;e++){var g=b.charAt(e);var d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(g);0<=d&&(g="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((d+47)%94));c+=g}return c}function A(){return Math.floor(1E12*(Math.random()+
...
(b=(b|1<<c)>>>0)},e=function(b,c){return function(){return b.apply(c,arguments)}},g="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):g?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},f=["Moz","O","ms","Webkit"],n=["moz","o","ms","webkit"],l={style:d("modernizr").style},u=function(b,c,f,e){function k(){h&&(delete l.style,
delete l.modElem)}e="undefined"===typeof e?!1:e;if("undefined"!==typeof f){var g=nativeTestProps(b,f);if("undefined"!==typeof g)return g}for(g=["modernizr","tspan","samp"];!l.style&&g.length;){var h=!0;l.modElem=d(g.shift());l.style=l.modElem.style}var m=b.length;for(g=0;g<m;g++){var n=b[g];var q=l.style[n];~(""+n).indexOf("-")&&(n=cssToDOM(n));if(void 0!==l.style[n]){if(e||"undefined"===typeof f)return k(),"pfx"==c?n:!0;try{l.style[n]=f}catch(w){}if(l.style[n]!=q)return k(),"pfx"==c?n:!0}}k();return!1},
q=function(b,c,d,g,l){var k=b.charAt(0).toUpperCase()+b.slice(1),h=(b+" "+f.join(k+" ")+k).split(" ");if("string"===typeof c||"undefined"===typeof c)return u(h,c,g,l);h=(b+" "+n.join(k+" ")+k).split(" ");for(var m in h)if(h[m]in c){if(!1===d)return h[m];b=c[h[m]];return"function"===typeof b?e(b,d||c):b}return!1};c(0,!0);c(1,!!function(b,c,d){if(0===b.indexOf("@"))return atRule(b);-1!=b.indexOf("-")&&(b=cssToDOM(b));return c?q(b,c,d):q(b,"pfx")}("requestFileSystem",window));c(2,window.CSS?"function"==
typeof window.CSS.escape:!1);c(3,q("shapeOutside","content-box",!0));return b}catch(k){return 0}}function T(){try{var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(g){}var e=0;c=function(b,c){c&&(e=(e|1<<b)>>>0)};doc=b.document;c(14,b.playerInstance&&b.document.querySelector('script[src*="ads-player.com"]'));c(15,b.zpz&&b.zpz.createPlayer);c(15,b.vdApp&&b.vdApp.createPlayer);c(15,b.document.querySelector('body>div[class="z-z-z"]'));c(16,b.xy_checksum&&
b.place_player&&b.logjwonready&&b.logContentPauseRequested);c(17,b==b.top&&""==b.document.title?(a=b.document.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);c(17,b.document.querySelector('script[src*="sitewebvideo.com"]'));c(17,b.InitPage&&b.cef&&b.InitAd);c(17,b==b.top&&""==doc.title?(a=doc.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):
!1);c(17,b==b.top&&""==doc.title&&b.InitAdPlayer?(a=doc.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);return e}catch(g){return 0}}function R(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},f=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var e=Math.ceil((b.length/4+2)/16),g=Array(e),m=0;m<
e;m++){g[m]=Array(16);for(var h=0;16>h;h++)g[m][h]=b.charCodeAt(64*m+4*h)<<24|b.charCodeAt(64*m+4*h+1)<<16|b.charCodeAt(64*m+4*h+2)<<8|b.charCodeAt(64*m+4*h+3)}g[e-1][14]=8*(b.length-1)/Math.pow(2,32);g[e-1][14]=Math.floor(g[e-1][14]);g[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;h=4023233417;var r=2562383102,y=271733878,B=3285377520,t=Array(80);for(m=0;m<e;m++){for(var p=0;16>p;p++)t[p]=g[m][p];for(p=16;80>p;p++)t[p]=c(t[p-3]^t[p-8]^t[p-14]^t[p-16],1);var v=b;var x=h;var w=r;var z=y;var A=B;
for(p=0;80>p;p++){var E=Math.floor(p/20),C=c(v,5);a:{switch(E){case 0:var D=x&w^~x&z;break a;case 1:D=x^w^z;break a;case 2:D=x&w^x&z^w&z;break a;case 3:D=x^w^z;break a}D=void 0}E=C+D+A+f[E]+t[p]&4294967295;A=z;z=w;w=c(x,30);x=v;v=E}b=b+v&4294967295;h=h+x&4294967295;r=r+w&4294967295;y=y+z&4294967295;B=B+A&4294967295}return d(b)+d(h)+d(r)+d(y)+d(B)}function c(){try{return!!window.sessionStorage}catch(f){return!0}}function e(){try{return!!window.localStorage}catch(f){return!0}}function g(){var b=document.createElement("canvas");
if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}return null}try{var d=[];d.push(["lang",navigator.language||navigator.browserLanguage]);d.push(["tz",(new Date).getTimezoneOffset()]);d.push(["hss",c()?"1":"0"]);d.push(["hls",e()?"1":"0"]);d.push(["odb",
typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",g()]);return b(d.join("=!!!="))}catch(f){return null}}this.createRequest=function(){var b=!1,c=window._dv_win,e=0,g=!1,d;try{for(d=0;10>=d;d++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,e++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(r){b=!1}0==c.document.referrer.length?b=c.location:b?
b=c.location:(b=c.document.referrer,g=!0);if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};var f=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();d=f.script;this.dv_script_obj=f;this.dv_script=d;window._dv_win.dvbsProcessed.push(f);window._dv_win._dvScripts.push(d);var n=d.src;this.dvOther=
0;this.dvStep=1;var l=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():A():A();f=window.parent.postMessage&&window.JSON;var u=!0,q=!1;if("0"==dv_GetParam(n,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)q=!0;if(f&&0==q)try{var k=G(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+l);u=C(k)}catch(r){}k={};try{q=/[\?&]([^&]*)=([^&#]*)/gi;
for(var m=q.exec(n);null!=m;)"eparams"!==m[1]&&(k[m[1]]=m[2]),m=q.exec(n);var h=k}catch(r){h=k}h.perf=this.perf;h.uid=l;h.script=this.dv_script;h.callbackName="__verify_callback_"+h.uid;h.tagObjectCallbackName="__tagObject_callback_"+h.uid;h.tagAdtag=null;h.tagPassback=null;h.tagIntegrityFlag="";h.tagHasPassbackFlag="";0==(null!=h.tagformat&&"2"==h.tagformat)&&(m=O(h.script),h.tagAdtag=m.tagAdTag,h.tagPassback=m.tagPassback,m.isBadImp?h.tagIntegrityFlag="&isbadimp=1":m.hasPassback&&(h.tagHasPassbackFlag=
"&tagpb=1"));(m=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?k="https:":(k=h.script.src,n="http:",l=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=k.match("^https")||"https"!=l&&"http"==l||(n="https:"),k=n);h.protocol=k;h.ssl="0";"https:"===h.protocol&&(h.ssl="1");k=h;(n=window._dv_win.dvRecoveryObj)?("2"!=k.tagformat&&(n=n[k.ctx]?n[k.ctx].RecoveryTagID:
n._fallback_?n._fallback_.RecoveryTagID:1,1===n&&k.tagAdtag?document.write(k.tagAdtag):2===n&&k.tagPassback&&document.write(k.tagPassback)),k=!0):k=!1;if(k)return{isSev1:!0};this.dvStep=2;N(h,m);d=d&&d.parentElement&&d.parentElement.tagName&&"HEAD"===d.parentElement.tagName;this.dvStep=3;return I(this,h,b,c,e,g,f,u,d,m)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b);try{var e=K(this.dv_script_obj&&
this.dv_script_obj.injScripts),g=G("about:blank");g.id=g.name;var d=g.id.replace("iframe_","");g.setAttribute&&g.setAttribute("data-dv-frm",d);C(g,this.dv_script);if(this.dv_script){var f=this.dv_script;a:{b=null;try{if(b=g.contentWindow){var n=b;break a}}catch(q){}try{if(b=window._dv_win.frames&&window._dv_win.frames[g.name]){n=b;break a}}catch(q){}n=null}f.dvFrmWin=n}var l=L(g);if(l)l.open(),l.write(e);else{try{document.domain=document.domain}catch(q){}var u=encodeURIComponent(e.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,
""));g.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+u+"');})()"}}catch(q){e=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(e+"/verify.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(q)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=I);this.getVersionParamName=function(){return"ver"};
this.getVersion=function(){return"94"}};
